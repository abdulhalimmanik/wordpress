#### problem
get_sidebar hero.php

pagination.php [don't understand]
apply_filter understrap_custom_header_args custom_header.php [not found]

wp_get_theme enque.php - done! 
jetpack_social_menu jetpack.php- done!
Custom render function for Infinite Scroll jetpack.php - done!
tiny_mce_before_init editor.php -done
mce_buttons_2 editor.php -done

login_errors security.php - done!
the_generator security.php - done!
get_post()->post_parent extras.php - done!


add_theme_support( 'customize-selective-refresh-widgets' ); setup.php - done
apply_filters( 'understrap_custom_background_args', array()); setup.php
delete_transient( 'understrap_categories' ); template-tags.php
get_categories() template-tags.php
wp_kses( __( )) content-none.php - done!
